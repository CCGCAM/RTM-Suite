...
enough to actually contain the real Sentinel-2 pixel values retrieved
in Section 3 -- a hybrid-inversion model can only be trusted on inputs
that fall inside the range it was trained on:
