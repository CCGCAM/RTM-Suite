---
title: "Full pipeline: simulate, convolve, invert"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Full pipeline: simulate, convolve, invert}
...
This article walks through the `Scripts/R/For*/` course pipeline shipped in the
...
`Scripts/R/Pipeline/1-simulate_LUT.R`, and every `ForXXX` folder all call it the
same way.
...
is no separate script per model in `Scripts/R/Pipeline/`, and the per-folder
...
- `Scripts/R/Pipeline/README.md` -- the underlying generic simulate/invert
