...
#' @param soilpar list. Soil parameters: BSMBrightness (soil brightness), BSMlat (spectral shape latitude, 20-40 deg), BSMlon (spectral shape longitude, 45-65 deg).
#' @param spec list. Spectral inputs: GSV (Global Soil Vectors spectra), Kw (water absorption spectrum), nw (water refraction index spectrum).
#' @param emp list. Empirical parameters, including SMp (soil moisture volume percentage, 5-55).
#'
#' @return
