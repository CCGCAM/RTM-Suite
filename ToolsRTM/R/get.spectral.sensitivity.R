...
#' own \code{STi} (total Sobol index) column, since that column doesn't vary
#' meaningfully across traits; \code{I.Johnson_norm} is the same metric this
#' package's reference sensitivity scripts (\code{TOcheck/sensibilidad/})
#' already use for this exact figure.
#'
...
#'   \code{STi_pct} for consistency with other functions in this package) --
#'   long format, ready for \code{ggplot2::geom_area(position = "stack")}.
#' @export
#'
#' @examples
#' \dontrun{
