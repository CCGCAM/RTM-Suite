...
#> 19/19 - 0s - 86ms/epoch - 5ms/step
#> Dense DL, independent test set: R2= 0.08  RMSE= 15.16  bias= 0.7
```
...
| method                                     |    R2 |  RMSE |
|:-------------------------------------------|------:|------:|
| Dense DL (getMLmodel)                      | 0.080 | 15.16 |
...
#> CNN (PRISMA,  234 bands), independent test set: R2= -0.328  RMSE= 19.15
```
