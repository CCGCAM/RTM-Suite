...
Allow user to draw from a random log-normal distribution correlated with
...
a single numeric value drawn from a normal distribution correlated with
x at the level of rho
