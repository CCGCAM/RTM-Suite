...
- sensor.i:
  ...
  objects, e.g. [`ToolsRTM::Sentinel2A.MSI`](sensor-smac-srf.md),
  [`ToolsRTM::LANDSAT8.OLI`](sensor-smac-srf.md),
  [`ToolsRTM::TerraAqua.MODIS`](sensor-smac-srf.md) (also accepts the
  bare sensor name as a character string, e.g. `"LANDSAT8.OLI"`, which
  is resolved to the matching bundled object automatically). Supported
  sensors: "LANDSAT4.TM", "LANDSAT5.TM", "LANDSAT7.ETM", "LANDSAT8.OLI",
