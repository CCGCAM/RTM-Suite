...
`foursail.inf` The foursail (or 4SAIL) radiative transfer model is a RT
model uses for simulating bidirectional reflectance distribution
...
- rsoil:
  ...
  numeric. understorey reflectance
