...
![](t11-photosynthesis-capstone_files/figure-html/two-models-plot-1.png)
...
![](t11-photosynthesis-capstone_files/figure-html/stac-plot-1.png)
...
first, before anything derived from them – so the NDVI and `Actot` maps
in 6b/6c below can be read against what the forest actually looked like
from orbit that month, not just as abstract colored grids.
...
![](t11-photosynthesis-capstone_files/figure-html/rgb-quicklook-1.png)
...
The same greenness signal Sections 4-5 reduced to one number per date,
now spatially resolved across the same scene shown in true color above:
...
![](t11-photosynthesis-capstone_files/figure-html/ndvi-map-1.png)
...
![](t11-photosynthesis-capstone_files/figure-html/actot-map-1.png)
