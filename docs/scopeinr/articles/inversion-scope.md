# Trait inversion from SCOPE reflectance
...
solves for. This page tests the practical consequence: **can you
actually retrieve `Vcmax25` from sensor-band reflectance, the way you
can retrieve `Cab` or `LAI`?**
...
![](inversion-scope_files/figure-html/invert-plots-1.png)
...
package’s `InversionOpt` article for the LUT merit-function-matching
alternative to Random Forest (applied there to plain PROSAIL rather than
full SCOPE).
