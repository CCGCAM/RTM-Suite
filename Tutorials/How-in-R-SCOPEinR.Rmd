...
Canopy-average leaf temperature responds to Cab through the energy
balance (chlorophyll content changes absorbed PAR, which feeds into the
leaf's own solved temperature), on top of whatever meteorological forcing
is fixed in this LUT.
