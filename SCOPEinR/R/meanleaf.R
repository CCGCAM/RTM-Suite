...
#'
#' @return numeric vector. \code{Fout_vertical}: for \code{canopy.choice = 'angles'}, one averaged value per layer (length \code{nl}); for \code{'layers'}, a single averaged value; for \code{'angles_and_layers'}, one averaged value per layer (length \code{nl}).
#' @export
#'
