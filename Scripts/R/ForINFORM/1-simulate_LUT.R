# ==============================================================================
# ForINFORM course pipeline, step 1/3: simulate a LUT (INFORM canopy model --
# forest reflectance with explicit crown geometry/shadowing, distinct from
# fourSAIL's turbid-medium canopy), convolve to Sentinel-2A/2B/PRISMA, compute
# indices, save a full set of diagnostic figures (trait histograms, trait
# correlations, spectra by trait percentile, sensor-convolution comparison).
...
# INFORM-specific (forest crown geometry) params. NOTE: exact-match
