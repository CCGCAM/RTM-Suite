# ==============================================================================
# ForMARMIT course pipeline, step 3/3: deep-learning trait inversion (SMC only)
# (ToolsRTM::getMLmodel(), 'CNN' and 'Hidden-layers' architectures,
# TensorFlow/Keras) for Cab, LAI, EWT. Run Scripts/Pipeline/0-setup_python_env.R
# once first if you haven't already.
#
...
target_traits <- c("SMC")  # MARMIT is soil-only -- no Cab/LAI/EWT here, just soil moisture
