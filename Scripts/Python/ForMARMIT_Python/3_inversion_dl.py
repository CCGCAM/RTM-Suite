...
Python equivalent of Scripts/R/ForMARMIT/3-inversion_DL.R
...
dataset only (not the sensor-convolved ones, like 2_inversion_ml.py) to
...
def main():
    ...
    results = []
    fig, axes = plt.subplots(len(TARGET_TRAITS), 3, squeeze=False, figsize=(12, 4 * len(TARGET_TRAITS)))
