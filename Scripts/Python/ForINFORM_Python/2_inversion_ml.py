"""Invert Cab, LAI, EWT from spectral indices using classical ML.

Python equivalent of Scripts/R/ForINFORM/2-inversion_ML.R. Same
...
LUT_COLUMNS = ["N", "Cab", "Car", "Anth", "EWT", "LMA", "alpha", "Cs", "fqe", "Cx", "Prot", "CBC",
...
def run_for_dataset(dataset_path: Path, label: str, results: list):
    ...
    fig, axes = plt.subplots(len(TARGET_TRAITS), len(MODELS) + 1,
